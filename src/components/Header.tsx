...
import { Search, ShoppingBag, ShieldCheck, Dna, X, LogIn, LogOut, CloudCheck } from 'lucide-react';
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          {firebaseUser ? (
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-200 p-2 z-50 animate-in fade-in slide-in-from-top-2">
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 py-1.5 text-xs text-rose-600 hover:bg-rose-50 rounded-lg flex items-center gap-2 font-medium mt-1"
                  >
            ...
            <button
              ...
              className="flex items-center gap-1 text-[11px] font-semibold text-slate-700 hover:text-[#006750] hover:bg-emerald-50 border border-slate-200/80 px-2.5 py-1.5 rounded-full transition-colors"
              title="Entrar com Google (Firebase)"
              id="header-login-btn"
            >
